...
(function ($) {
  $.fn.sappleMultiSlider = function (options) {
    ...
    var slideTo = function (direction) {
      ...
      if (direction == "prev") {
        ...
        sliderUL
          .prepend(
            newItem
              .removeClass("slide-align-right")
              .addClass("slide-align-left")
          )
          .css({
        ...
        sliderUL.append(
          newItem.removeClass("slide-align-left").addClass("slide-align-right")
        );
      }
    ...
    var highlight = function (direction) {
      ...
      var nextIndex;
      if (direction == "prev") {
        if (currIndex == 0) nextIndex = sliderItems.length;
        else nextIndex = currIndex;
      } else if (direction == "next") {
        if (currIndex == sliderItems.length - 1) nextIndex = 1;
        else nextIndex = currIndex + 2;
      }
    ...
    this.destroy = function (reset) {
      $this
        .removeData("sappleMultiSlider")
        .removeClass("sappleMultiSliderContainer")
        .removeAttr("style");
      sliderUL.empty().append(sliderItems);
      sliderItems
        .removeAttr("data-index")
        .removeClass("slide-align-left slide-align-right slide-current")
        .css({
          float: "",
          width: "",
          "margin-top": "",
    ...
    this.create = function () {
      ...
      if (
        opts.beforeCreateFunction != null &&
      ...
      pagination = $(
        '<div class="pagination"><a href="#" class="prev  arrow-left_project">Previous</a><span class="counter"><em class="current"></em> of <em class="total"></em></span><a href="#" class="next  arrow-right_project">Next</a></div>'
      );
      ...
      if (indexCurr > 2) {
        for (var i = 0; i < indexCurr - 2; i++) {
          (function () {
            var obj = $(sliderItems[i])
              .removeClass("slide-align-left")
              .addClass("slide-align-right");
      ...
      btns
        .on("mouseover", function () {
          if ($(this).hasClass("prev")) highlight("prev");
          else if ($(this).hasClass("next")) highlight("next");
        })
        ...
        .on("click", function (e) {
          ...
          if ($(this).hasClass("prev")) $this.prev();
          else if ($(this).hasClass("next")) $this.next();
        });
      ...
      interval3 = setInterval(function () {
        btns1.trigger("click", function (e) {
          ...
          if (isAnimating) return;
          if ($(this).hasClass("next")) $this.next();
          else if ($(this).hasClass("prev")) $this.prev();
        });
      }, 4000);
