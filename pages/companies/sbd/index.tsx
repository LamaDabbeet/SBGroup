        ...
        >
          <SwiperSlide>
            <div className={sbdStyles.container}>
              ...
              <div className={sbdStyles.overlay}>
                <div className={sbdStyles.text}>{t("mostaqellaProject")}</div>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={sbdStyles.container}>
              ...
              />
              <div className={sbdStyles.overlay}>
                <div className={sbdStyles.text}>{t("artouzProject")}</div>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={sbdStyles.container}>
              ...
              <div className={sbdStyles.overlay}>
                <div className={sbdStyles.text}>{t("manahelProject")}</div>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
